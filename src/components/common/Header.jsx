            ...
            <div>
              <ul className="text-xltext-black flex gap-10 uppercase">
                <Link href="/pages/pageOne">
                  <li className="cursor-pointer hover:text-gray-500">Page 1</li>
                </Link>
                <Link href="/pages/pageTwo">
                  <li className="cursor-pointer hover:text-gray-500">Page 2</li>
                </Link>
                <Link href="/pages/pageThree">
                  <li className="cursor-pointer hover:text-gray-500">Page 3</li>
                </Link>
